          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            {QUICK_PROMPTS.map((prompt, idx) => (
              <button
                ...
                className="px-3 py-2 rounded-lg border border-white/5 bg-zinc-900/50 text-zinc-400 text-xs hover:border-primary-400/30 hover:text-primary-400 transition-all cursor-pointer text-center flex items-center justify-center min-h-[44px] break-keep"
              >
                {prompt}
              </button>
            ))}
